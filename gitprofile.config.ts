...
const CONFIG = {
  github: {
    username: 'HaloReach2552', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  projects: {
    ...
    external: {
      header: 'Portafolio de Proyectos',
  ...
  resume: {
    fileUrl:
      'https://github.com/HaloReach2552/Portfolio/blob/main/public/ERIK_CV.docx.pdf', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'Python',
    'Machine Learning',
  ...
  experiences: [
    ...
    {
      company: 'Transvial',
      position: 'Practicante Data Analytics',
      from: 'January 2023',
      to: 'November 2023',
      companyLink: 'https://example.com',
    },
